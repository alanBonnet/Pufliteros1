<div class="container my-3 animate__animated animate__bounceIn" id="contacto" hidden>
    <form class="bg-dark text-white p-5 rounded-lg border-3 border border-warning" action="">
        <label class="form-label fs-3" for="">Nombre</label>
        <input class="form-control border-3 border-secondary" type="text">
        <label class="form-label fs-3" for="">Dinos qué piensas</label>
        <textarea name="" id="" cols="30" rows="10" class="form-control border-3 border-secondary"></textarea>
