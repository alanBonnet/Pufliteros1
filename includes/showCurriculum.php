            ...
            <div class="row">
                <div class="col-lg-4 bg-dark text-white text-center py-4">
                    <div class="header-left">
                        ...
                        <h1 class="display-5">Lautaro Durante</h1>
                        <h4 class="lead text-uppercase text-white-50 nb-4">Programador</h4>
                    </div>
                    ...
                    <ul class="list text-white-50 ml-5 py-2 text-left text-capitalize">
                        <li class="list-item">Habilidades para resolver el problema</li>
                        <li class="list-item">Comunicacion verbal</li>
                        <li class="list-item">Servicio al cliente</li>
                    </ul>
                    </div>
                    ...
                    <ul class="list text-white-50 ml-5 py-2 text-left text-capitalize">
                        <li class="list-item">Colegio Secundario Don Bosco</li>
                        <li class="list-item">Colegio Secundario Don Bosco</li>
                        <li class="list-item">Colegio Secundario Don Bosco</li>
                    </ul>
                    </div>
                ...
                <div class="col-lg-8 bg-light text-dark py-5 px-5">
                    <div class="head-right">
                        ...
                        <hr>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi debitis ducimus nesciunt. Magni nesciunt perspiciatis porro eligendi quos. Enim quidem quod saepe ipsam beatae eum dolor. Enim tenetur culpa libero earum quasi amet praesentium architecto aliquam asperiores molestias esse reiciendis modi sint, error sequi beatae harum necessitatibus possimus cumque quis?</p>
                    </div>
